...
import { RegularerFinanzplanActions, finanzplanActionTypes } from '@app/kiss4-sozialhilfe/regularer-finanzplan/store/actions/regularer-finanzplan.actions';
...
interface IVerlaufState extends AppEntityCustomState<any> { }
interface ITypVerlaufState extends AppEntityCustomState<any> { }
...
export interface IState {
  ...
  finanzplanVerlaufState: IVerlaufState;
  finanzplanTypVerlaufState: ITypVerlaufState;
}
...
export const initialState: IState = {
  ...
  finanzplanVerlaufState: getInitState(),
  finanzplanTypVerlaufState: getInitState()
};

export function reducer(state = initialState, action: RegularerFinanzplanActions): IState {
  ...
  switch (action.type) {
    ...
    case finanzplanActionTypes.VerlaufDataTypes.LOAD: {
      return Object.assign({}, state, {
        finanzplanVerlaufState: {
          loading: true,
          query: action.payload
        }
      });
    }
    case finanzplanActionTypes.VerlaufDataTypes.LOAD_SUCCESS: {
      return Object.assign({}, state, {
        finanzplanVerlaufState: {
          loaded: true,
          loading: false,
    ...
    case finanzplanActionTypes.VerlaufDataTypes.LOAD_FAIL: {
      return Object.assign({}, state, {
        finanzplanVerlaufState: {
          loaded: false,
          loading: false,
    ...
    case finanzplanActionTypes.TypVerlaufDataTypes.LOAD: {
      return Object.assign({}, state, {
        finanzplanTypVerlaufState: {
          loading: true,
          query: action.payload
        }
      });
    }
    case finanzplanActionTypes.TypVerlaufDataTypes.LOAD_SUCCESS: {
      return Object.assign({}, state, {
        finanzplanTypVerlaufState: {
          loaded: true,
          loading: false,
    ...
    case finanzplanActionTypes.TypVerlaufDataTypes.LOAD_FAIL: {
      return Object.assign({}, state, {
        finanzplanTypVerlaufState: {
          loaded: false,
          loading: false,
...
export const verLaufDataStatus = {
  getData: (state: IState) => state.finanzplanVerlaufState.data,
};

export const typVerLaufDataStatus = {
  getData: (state: IState) => state.finanzplanTypVerlaufState.data,
};
