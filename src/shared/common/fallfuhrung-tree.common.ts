export class FallfuhrungTreeConstant {
  ...
  public static CtlWohnkosten = 'CtlBgWohnkosten';
  public static CtlMedGrundversorgung = 'CtlBgMedGrundversorgung';

  // surfix endPoint for S
  public static Sozialhilfe  = 'Sozialhilfe';
  public static WhLeistung  = 'WhLeistung';
  public static Kontoauszug = 'Kontoauszug';
  public static WhFinanzplan = 'WhFinanzplan';
  public static WhRegularerFinanzplan = 'RegularerFinanzplan';
  ...
  public static BgAlimente = 'BgAlimente';
  ...
  public static Wohnkosten = 'Wohnkosten';
  public static MedGrundversorgung = 'MedGrundversorgung';
